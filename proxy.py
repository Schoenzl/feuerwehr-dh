#!/usr/bin/env python3
"""
WASTL Proxy – FF Deutsch Haslau / Bezirk Bruck/Leitha
...
def fetch_loop():
    while True:
        try:
            ...
            print(f"[{cache['letzte_aktualisierung']}] {len(einsaetze)} Einsätze", flush=True)
...
if __name__ == "__main__":
    ...
    time.sleep(3)  # Ersten Abruf abwarten
